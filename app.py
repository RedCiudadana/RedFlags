...
def fetch_red_flags_red01():
    ...
    filepath = 'resultados/red_flag01.json' 
    with open(filepath, 'r') as jsonfile:
        red_flags = json.load(jsonfile)
...
def fetch_red_flags_red02():
    ...
    filepath = 'resultados/red_flag02.json' 
    with open(filepath, 'r') as jsonfile:
        red_flags = json.load(jsonfile)
...
def fetch_red_flags_red03():
    ...
    filepath = 'resultados/red_flag03.json' 
    with open(filepath, 'r') as jsonfile:
        red_flags = json.load(jsonfile)
...
def fetch_red_flags_red04():
    ...
    filepath = 'resultados/red_flag04.json' 
    with open(filepath, 'r') as jsonfile:
        red_flags = json.load(jsonfile)
...
def fetch_red_flags_red05():
    ...
    filepath = 'resultados/red_flag05.json' 
    with open(filepath, 'r') as jsonfile:
        red_flags = json.load(jsonfile)
